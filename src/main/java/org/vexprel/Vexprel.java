...
/**
 * <p>
 *  Class meant to keep some constants related to the version of the Vexprel library being used, build date, etc.
 * </p>
 *
...
public final class Vexprel {
    ...
    static {
        ...
        try {
            ...
            properties.load(ClassLoaderUtils.loadResourceAsStream("org/vexprel/vexprel.properties"));
        ...
        if (VERSION == null || VERSION.trim().length() == 0) {
            ...
            try {
                ...
                throw new ExceptionInInitializerError(
                        "Exception during initialization of Vexprel versioning utilities. Identified Vexprel " +
